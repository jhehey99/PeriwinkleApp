...
{
	public interface IClientBehaviorView
	{
		void DisplayBehaviorFiles (List <BehaviorAdapterModel> behaviorDataSet);
		void LaunchViewBehavior (BehaviorGraph behaviorGraph);
	}

	//TODO LIST AKO
    public class ClientBehaviorView : RecyclerFragment <BehaviorRecyclerAdapter, BehaviorAdapterModel>,
										  IClientBehaviorView
	{
		private IClientBehaviorListPresenter presenter;

		private readonly string sessionKeyToUse;

		public ClientBehaviorView (string sessionKeyToUse = null)
		{
		...
		{
			IsAnimated = true;
			presenter = new ClientBehaviorListPresenter(this, sessionKeyToUse);
		}
		...
		protected override void OnFloatingActionButtonClicked (object sender, EventArgs e)
		{
			...
			// pag cinlick ung fab, mag open ung behavior activity
        ...
        #region IClientBehaviorView

        public void DisplayBehaviorFiles (List <BehaviorAdapterModel> behaviorDataSet)
		{
			UpdateAdapterDataSet(behaviorDataSet);
			HideProgressBar();
		}
